package com.example.vimadhavan.assignment94;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button check_permission = (Button) findViewById(R.id.checkBtn);
        Button request_permission = (Button) findViewById(R.id.requestBtn);
